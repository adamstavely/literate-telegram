// Docs content. Plain JS — attaches to window.DOCS.
// Block types: lead, h2, h3, p, code, callout, list, steps, cards, table, divider, keyval.
// Inline markup inside strings: **bold**, `code`, [label](slug-or-#anchor).
(function () {
  const NAV = [
    {
