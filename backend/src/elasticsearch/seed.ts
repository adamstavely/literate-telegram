...
const stubTools = (n: number, parent: string): Tool[] =>
...
const pendingEntries: PendingEntry[] = [
  {
    ...
    entry: {
      ...
      description: 'Read file structure, components, and design tokens from Figma.',
      sensitivity: 'internal',
      categories: ['design'],
      transports: ['http'],
      auth: 'OAuth 2.1',
      tools: stubTools(7, 'figma'),
      clients: [],
      license: 'MIT',
  ...
  },
  {
    ...
    entry: {
      ...
      transports: ['stdio'],
      auth: 'None',
      tools: stubTools(2, 'shell-runner'),
      clients: [],
      license: 'MIT',
  ...
  },
  {
    ...
    entry: {
      ...
      description: 'Walk a new customer through setup using our internal playbook.',
      sensitivity: 'internal',
  ...
  },
  {
    ...
    entry: {
      ...
      description: 'Current conditions and forecasts by location.',
      sensitivity: 'public',
      categories: ['search'],
      transports: ['http'],
      auth: 'API key',
      tools: stubTools(2, 'weather'),
      clients: [],
      license: 'MIT',
      source: 'https://example.com',
      verified: false,
  ...
  },
  {
    id: 'p-drop-table',
    entry: {
      id: 'pending-drop-table',
      type: 'tool',
      name: 'drop_table',
      slug: 'anthropic/postgres:drop_table',
      publisher: 'k.alvarez',
      summary: 'Permanently delete a table and all of its rows.',
      description: 'Permanently delete a table and all of its rows.',
      sensitivity: 'restricted',
      categories: ['data-analytics'],
      parentServer: 'Postgres',
      readOnly: false,
      returns: 'void',
      params: [],
      verified: false,
